      ...
      <Box className={styles["expenses"]}>
        ...
        <main className={styles["expenses__main"]}>
          <Box className={styles["expenses__main__container-info"]}>
            <Box
              className={
                styles["expenses__main__container-info__navigation"]
              }
            >
              <select
                ...
                className={
                  styles[
                  "expenses__main__container-info__navigation__select"
                  ]
                }
              >
                <option
                  ...
                  className={
                    styles[
                    "expenses__main__container-info__navigation__select__options"
                    ]
                  }
                >
                  Despesas
            ...
            <Box
              className={
                styles["expenses__main__container-info__container"]
              }
            >
              <Box
                className={
              ...
              <Box
                className={
                  styles["expenses__main__container-info__container__right"]
                }
              >
                {(["income", "expenses", "transfer"] as const).map((type) => (
                  <Box
                    key={type}
                    className={
                      styles["expenses__main__container-info__container__right__function"]
                    }
                  ...
                  >
                    <Box
                      className={
                        styles["expenses__main__container-info__container__right__function__icon-area"]
                      }
                    >
                    ...
                    <p
                      className={
                        styles["expenses__main__container-info__container__right__function__text"]
                      }
                    >
                      {type === "income"
                        ? "Receitas"
          ...
          <ButtonTransactions
            ...
            className={styles["expenses__main__button--hidden"]}
          />
        </main>
      </Box>
      <Footer/>
