      ...
      <Box className={styles["content"]}>
        ...
        <main>
          <Box className={styles["container"]}>
            ...
            <Box className={styles["container__material"]}></Box>
            <Box className={styles["container__material__left"]}>
              ...
              <p className={styles["container__material__left__text"]}>
                Acreditamos que educação financeira não precisa ser complicada.
                Com o Poup.ai, você tem uma visão clara do que faz sentido
                manter, ou melhorar — sem fórmulas mágicas, apenas
                transparência, praticidade e resultados.
              </p>
              <p className={styles["container__material__left__text"]}>
                Nosso compromisso é com a sua liberdade financeira. Estamos aqui
                para mostrar que, com informação e organização, seu dinheiro
                pode trabalhar melhor para você.
              </p>
            </Box>
